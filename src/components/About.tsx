  ...
  return (
    <section className="p-5 md:px-20 h-screen md:pt-10">
      ...
      <main className="flex flex-col lg:justify-between lg:flex-center gap-5 items-center lg:flex-row-reverse">
        <div className="w-80"><img src={profilepic} alt="" className="w-full object-cover rounded-xl" /></div>
        <div className="w-1/2 text-justify space-y-4">
          <h2 className="text-3xl">I'm Elo-oghene. I live in Lagos, where I build the future.</h2>
          ...
          <p>I’m currently on the lookout for exciting challenges and internship opportunities where I can apply my skills, learn from industry experts, and contribute to impactful projects.</p>
